...
function App() {
  const [selectedProgramId, setSelectedProgramId] = useState("sales-shakthi");
...
Registration for 21 Days Magical Sales has been automatically confirmed.`;
  ...
  function validate() {
    ...
    if (form.profession.trim().length < 2) {
      e.profession = "Please enter your profession.";
    }
    ...
    try {
      ...
      const options = {
        ...
        notes: {
          ...
          programId: selectedProgramId,
          programName: orderData.program.name,
        },
        theme: {
          color: "#F8C537",
        },
        ...
        <div className="form-card">
          <form onSubmit={submitForm}>
            ...
            <button className="primary-btn" disabled={loading}>
              {loading
                ? "Please wait..."
                : `Pay ₹${selectedProgram.amountInr.toLocaleString(
                    "en-IN"
                  )} & Register`}
            </button>
